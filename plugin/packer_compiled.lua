...
_G.packer_plugins = {
  ...
  ["completion-nvim"] = {
    loaded = true,
    path = "/home/scutta/.local/share/nvim/site/pack/packer/start/completion-nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-treesitter", "cmp-nvim-lua", "cmp-cmdline", "cmp-buffer", "cmp_luasnip", "cmp-path", "LuaSnip", "cmp-emoji", "friendly-snippets", "cmp-calc" },
